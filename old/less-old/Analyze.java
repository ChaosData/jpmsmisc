...
class Analyze {
  ...
  public static void main(String[] argv) {
    try {
      ...
      Method getObject_2 = unsafe.getClass().getMethod("getObject", Object.class, long.class);
      ...
      for (Field ff : System.class.getDeclaredFields()) {
        System.out.println(ff);
      }
      Field err = (Field)System.class.getField("err");
      Method staticFieldBase_1 = unsafe.getClass().getMethod("staticFieldBase", Class.class);
      Method staticFieldOffset_1 = unsafe.getClass().getMethod("staticFieldOffset", Field.class);

      long off_err = (Long)staticFieldOffset_1.invoke(unsafe, err);
      System.out.println(off_err);
      Object z = getObject_2.invoke(unsafe, System.class, off_err+4);
      if (z == null) {
      ...
      z = getObject_2.invoke(unsafe, System.class, off_err+4);
      if (z == null) {
        System.out.println("null");
      } else {
        System.out.println(z.getClass());
